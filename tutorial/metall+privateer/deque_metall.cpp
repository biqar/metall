...
const string SNAPSHOT_DIR = "/l/ssd/privateer-deque/snapshot_";
...
int main() {
  ...
  {
    metall::manager metall_mgr(metall::create_only, "/l/ssd/privateer-deque/metall");
  ...
  {
    metall::manager metall_mgr(metall::open_only, "/l/ssd/privateer-deque/metall");
  ...
  // destructor
  {
    metall::manager metall_mgr(metall::open_read_only, "/l/ssd/privateer-deque/metall");
    auto pdeque = metall_mgr.find<deque_t>("deque").first;
