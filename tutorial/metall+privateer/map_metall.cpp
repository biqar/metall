...
const string SNAPSHOT_DIR = "/l/ssd/privateer-map/snapshot_";
...
int main() {
  ...
  {
    metall::manager metall_mgr(metall::create_only, "/l/ssd/privateer-map/metall");
  ...
  {
    metall::manager metall_mgr(metall::open_only, "/l/ssd/privateer-map/metall");
  ...
  // destructor
  {
    metall::manager metall_mgr(metall::open_read_only, "/l/ssd/privateer-map/metall");
    auto pmap = metall_mgr.find<map_t>("map").first;
