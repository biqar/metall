...
const string SNAPSHOT_DIR = "/l/ssd/privateer-umap/snapshot_";
...
int main() {
  ...
  {
    metall::manager metall_mgr(metall::create_only, "/l/ssd/privateer-umap/metall");
  ...
  {
    metall::manager metall_mgr(metall::open_only, "/l/ssd/privateer-umap/metall");
  ...
  // destructor
  {
    metall::manager metall_mgr(metall::open_read_only, "/l/ssd/privateer-umap/metall");
    auto pumap = metall_mgr.find<umap_t>("umap").first;
