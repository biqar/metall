...
const string SNAPSHOT_DIR = "/l/ssd/privateer-uset/snapshot_";
...
int main() {
  ...
  {
    metall::manager metall_mgr(metall::create_only, "/l/ssd/privateer-uset/metall");
  ...
  {
    metall::manager metall_mgr(metall::open_only, "/l/ssd/privateer-uset/metall");
  ...
  // destructor
  {
    metall::manager metall_mgr(metall::open_read_only, "/l/ssd/privateer-uset/metall");
