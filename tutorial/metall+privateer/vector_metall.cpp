...
const string SNAPSHOT_DIR = "/l/ssd/privateer-vector/snapshot_";
...
int main() {
  ...
  {
    metall::manager metall_mgr(metall::create_only, "/l/ssd/privateer-vector/metall");
  ...
  {
    metall::manager metall_mgr(metall::open_only, "/l/ssd/privateer-vector/metall");
  ...
  // destructor
  {
    metall::manager metall_mgr(metall::open_read_only, "/l/ssd/privateer-vector/metall");
    auto pvec = metall_mgr.find<vec_t>("vec").first;
