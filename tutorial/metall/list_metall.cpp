...
const string SNAPSHOT_DIR = "/l/ssd/metall-list/snapshot_";
...
int main() {
  ...
  {
    metall::manager metall_mgr(metall::create_only, "/l/ssd/metall-list/metall");
  ...
  {
    metall::manager metall_mgr(metall::open_only, "/l/ssd/metall-list/metall");
  ...
  // destructor
  {
    metall::manager metall_mgr(metall::open_read_only, "/l/ssd/metall-list/metall");
    auto plist = metall_mgr.find<list_t>("list").first;
